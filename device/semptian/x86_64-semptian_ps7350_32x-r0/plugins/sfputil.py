...
SFP_I2C_START_OFFSET_PS7350_2 = 22
SFP_I2C_START_OFFSET_PS7350_1 = 21
...
class SfpUtil(SfpUtilBase):
    ...
    SFP_I2C_START = SFP_I2C_START_OFFSET_PS7350_2 + offset
  
    hw_intf = get_hw_intf()
    if hw_intf == 1:
        SFP_I2C_START = SFP_I2C_START_OFFSET_PS7350_1 + offset
    else:
        SFP_I2C_START = SFP_I2C_START_OFFSET_PS7350_2 + offset
